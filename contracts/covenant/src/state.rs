...
/// contract code for the liquid staker module
pub const LS_CODE: Item<u64> = Item::new("ls_code");
/// contract code for the liquid pooler module
pub const LP_CODE: Item<u64> = Item::new("lp_code");
/// contract code for the depositor module
...
/// contract code for the holder module
...
/// fields related to the holder module known prior to covenant instatiation.
