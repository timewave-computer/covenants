...
pub fn test_single_party_pol_stride(test_ctx: &mut TestContext) -> Result<(), LocalError> {
    ...
    let code_id_astroport_tf_liquid_pooler = *test_ctx
        .get_chain(NEUTRON_CHAIN_NAME)
        .contract_codes
    ...
    let instantiate_covenant_msg = valence_covenant_single_party_pol::msg::InstantiateMsg {
        ...
        contract_codes: CovenantContractCodeIds {
            ...
            liquid_pooler_code: code_id_astroport_tf_liquid_pooler,
